...
export function PalmSvg({ side }: PalmSvgProps) {
  ...
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 360 600"
      className={`pointer-events-none absolute bottom-[-82px] z-[2] h-[380px] w-[228px] drop-shadow-[0_12px_30px_var(--color-palm-shadow)] sm:bottom-[-108px] sm:h-[500px] sm:w-[300px] md:bottom-[-130px] md:h-[600px] md:w-[360px] ${positionClasses}`}
    >
      {side === 'left' ? (
        <>
          ...
          <g>
            ...
            <path
              ...
              stroke="var(--color-palm-highlight)"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            />
