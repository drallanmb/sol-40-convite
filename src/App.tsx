...
import BackgroundMusic from './components/layout/BackgroundMusic.tsx'
...
const MUSIC_ROUTES = new Set(['/', '/confirmar', '/presentes'])
...
function App() {
  ...
  return (
    <>
      <BackgroundMusic enabled={MUSIC_ROUTES.has(location.pathname)} />
