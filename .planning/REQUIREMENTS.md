...
- [ ] **INVITE-01**: Hero com sol + contagem regressiva usando offset `-03:00` explícito (correto em qualquer fuso)
- [ ] **INVITE-02**: Seções de programa e dress code
- [ ] **INVITE-03**: Local + mapa de Aracaju + guia da cidade/hotéis
