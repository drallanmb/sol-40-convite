...
updated: 2026-07-25T06:02:06.769Z
---

## Current Test

number: 1
name: Two-session reactivity and authorization loss
expected: |
  RSVP, moderação e presente alterados numa sessão aparecem sem reload na outra sessão e nas superfícies públicas cabíveis; revogação, expiração ou logout limpam todo estado protegido e preservam apenas rota/filtro.
